...
#nameInfrastructure
INI_1_NAMEINFRA='EUMEDGRID-Support infrastructure'

#acronymInfrastructure
INI_1_ACRONYM='EUMEDGRID'
...
INI_1_BDIIHOST='ldap://bdii.eumedgrid.eu:2170'
...
#init_pxRobotId
INI_1_ROBOTID=bc681e2bd4c3ace2a4c54907ea0c379b

#init_pxRobotVO
INI_1_ROBOTVO=eumed

#init_pxRobotRole
INI_1_ROBOROLE=eumed
...
#nameInfrastructure
INI_2_NAMEINFRA='GridIt Italian Grid Infrastructure'

#acronymInfrastructure
INI_2_ACRONYM='GridIt'

#enableInfrastructure
INI_2_ENABLEINFRA=yes

#init_bdiiHost
# specify the information system BDII in the form ldap://<info_provider_hostname>:<info_provide_port>
INI_2_BDIIHOST='ldap://egee-bdii.cnaf.infn.it:2170'
...
#init_pxServerHost
INI_2_PXHOST='etokenserver.ct.infn.it'
...
#init_pxRobotId
INI_2_ROBOTID=332576f78a4fe70a52048043e90cd11f

#init_pxRobotVO
INI_2_ROBOTVO=gridit

#init_pxRobotRole
INI_2_ROBOROLE=gridit

#init_pxRobotRenewalFlag (true/false)
INI_2_RENEWALFLAG=true
...
#nameInfrastructure
INI_3_NAMEINFRA='GISELA Latin American Infrastructure'

#acronymInfrastructure
INI_3_ACRONYM='GISELA'

#enableInfrastructure
INI_3_ENABLEINFRA=yes

#init_bdiiHost
# specify the information system BDII in the form ldap://<info_provider_hostname>:<info_provide_port>
INI_3_BDIIHOST='ldap://top-bdii.grid.unam.mx:2170'

#init_wmsHost
# The wms host can be obtained from an UI with the gLite command line
# lcg-infosites --vo eumed wms
#
INI_3_WMSHOST='wms://wms-lb.grid.unam.mx:7443/glite_wms_wmproxy_server'

#init_pxServerHost
INI_3_PXHOST='etokenserver.ct.infn.it'
...
#init_pxRobotId
INI_3_ROBOTID=3258454c30c8d5f7c6d4440ff19d2999

#init_pxRobotVO
INI_3_ROBOTVO=prod.vo.eu-eela.eu

#init_pxRobotRole
INI_3_ROBOROLE=prod.vo.eu-eela.eu

#init_pxRobotRenewalFlag (true/false)
INI_3_RENEWALFLAG=true
